...
class Admin extends JFrame implements ActionListener
{
	...
	JMenuBar mb;
	JMenu m1,m2,m3;
	JMenuItem m1_1,m1_2,m1_3,m1_4,m2_1,m2_2,m2_3,m2_4,m3_1,m3_2,m3_3,m3_4;
	...
	public Admin(String username)
	{
		...
		m1_1=new JMenuItem("Create User");
		m1_2=new JMenuItem("Change Password");
		m1_3=new JMenuItem("Drop User");
		m1_4=new JMenuItem("Exit");
		m2_1=new JMenuItem("Party Master");
		m2_2=new JMenuItem("Purchase Item");
		m2_3=new JMenuItem("Distributor Payment");
		m2_4=new JMenuItem("Sale Item");
		m3_1=new JMenuItem("Itemwise Details");
		m3_2=new JMenuItem("Party Details");
		m3_3=new JMenuItem("Purchase Reports");
		m3_4=new JMenuItem("Sale Reports");
		m1.add(m1_1);
		m1.add(m1_2);
		m1.add(m1_3);
		m1.add(m1_4);
		...
		m1_3.setFont(new Font("Arial",Font.PLAIN,20));
		m1_4.setFont(new Font("Arial",Font.PLAIN,20));
		m2_1.setFont(new Font("Arial",Font.PLAIN,20));
		m2_2.setFont(new Font("Arial",Font.PLAIN,20));
		m2_3.setFont(new Font("Arial",Font.PLAIN,20));
		m2_4.setFont(new Font("Arial",Font.PLAIN,20));
		m3_1.setFont(new Font("Arial",Font.PLAIN,20));
		m3_2.setFont(new Font("Arial",Font.PLAIN,20));
		m3_3.setFont(new Font("Arial",Font.PLAIN,20));
		m3_4.setFont(new Font("Arial",Font.PLAIN,20));
		...
		m1_3.setForeground(clr1);
		m1_4.setForeground(clr1);
		m2_1.setForeground(clr1);
		m2_2.setForeground(clr1);
		m2_3.setForeground(clr1);
		m2_4.setForeground(clr1);
		m3_1.setForeground(clr1);
		m3_2.setForeground(clr1);
		m3_3.setForeground(clr1);
		m3_4.setForeground(clr1);
		p1.add(l1);
